...
public class RegExpProcessorTest {
	...
	public void testInvalidNullInput() {
		...
		assertFalse( RegExpProcessor.isInputValid(input) );
	}
	...
	public void testMinimalInputValid() {
		...
		Assert.assertTrue( RegExpProcessor.isInputValid(input));
	}
	...
	public void testBasicInputInValidNoSpaces() {
		...
		Assert.assertFalse( RegExpProcessor.isInputValid(input));
	}
